...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    { id: 'dashboard', path: '/dashboard', label: 'Início', icon: 'fas fa-th-large' },
    { id: 'scales', path: '/escalas/lista', label: 'Escalas', icon: 'fas fa-calendar-alt' },
    { id: 'music', path: '/musicas/estatisticas', label: 'Músicas', icon: 'fas fa-music' },
    { id: 'team', path: '/equipe', label: 'Equipe', icon: 'fas fa-users' },
  ];
  ...
  const isActive = (id: string) => {
    ...
    if (id === 'dashboard') return currentPath === '/dashboard';
    if (id === 'scales') return currentPath.startsWith('/escalas');
    if (id === 'music') return currentPath.startsWith('/musicas');
    if (id === 'team') return currentPath.startsWith('/equipe');
    return false;
  };
